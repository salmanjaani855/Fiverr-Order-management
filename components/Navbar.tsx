      ...
      <div className="max-w-full px-4 md:px-6 py-3.5 flex items-center justify-between gap-3">
        ...
        >
          <div className="flex items-center gap-3">
            <div className="w-3 h-3 rounded-full bg-[#2ecc71] shadow-md animate-pulse" style={{ animationDuration: '2s' }} />
        ...
        <div className="hidden md:flex items-center gap-3">
          <Link
            href="/dashboard"
            className={`font-semibold text-sm px-4 py-2 rounded-lg transition-all duration-200 ${pathname === "/dashboard" ? "text-[#2ecc71] bg-gray-900/30 dark:bg-white/5" : "text-gray-700 dark:text-gray-200 hover:text-gray-900 dark:hover:text-white hover:bg-gray-200/50 dark:hover:bg-white/5"}`}
          >
            Dashboard
          </Link>
          ...
          <Link
            href="/team"
            className={`font-semibold text-sm px-4 py-2 rounded-lg transition-all duration-200 ${pathname === "/team" ? "text-[#2ecc71] bg-gray-900/30 dark:bg-white/5" : "text-gray-700 dark:text-gray-200 hover:text-gray-900 dark:hover:text-white hover:bg-gray-200/50 dark:hover:bg-white/5"} flex items-center gap-2`}
          >
          ...
          <Link
            href="/tasks"
            className={`font-semibold text-sm px-4 py-2 rounded-lg transition-all duration-200 ${pathname === "/tasks" ? "text-[#2ecc71] bg-gray-900/30 dark:bg-white/5" : "text-gray-700 dark:text-gray-200 hover:text-gray-900 dark:hover:text-white hover:bg-gray-200/50 dark:hover:bg-white/5"}`}
          >
            Tasks
          </Link>
          ...
          <div className="relative">
            <button
              ...
              className="w-10 h-10 bg-gradient-to-br from-[#2ecc71] to-teal-600 hover:cursor-pointer text-white rounded-full flex items-center justify-center font-semibold hover:shadow-lg hover:shadow-teal-500/50 transition-all duration-200 transform hover:scale-105"
            >
              {getInitial()}
            </button>
