      ...
      <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
        <div className="text-center space-y-6">
          ...
          <div className="flex justify-center items-center gap-3">
            <div className="w-3 h-3 rounded-full bg-gradient-to-r from-cyan-500 to-blue-500 animate-bounce" style={{ animationDelay: '0s' }}></div>
            <div className="w-3 h-3 rounded-full bg-gradient-to-r from-cyan-500 to-blue-500 animate-bounce" style={{ animationDelay: '0.2s' }}></div>
            <div className="w-3 h-3 rounded-full bg-gradient-to-r from-cyan-500 to-blue-500 animate-bounce" style={{ animationDelay: '0.4s' }}></div>
          </div>
          ...
          <div className="relative w-16 h-16 mx-auto">
            ...
            <div className="absolute inset-0 animate-spin">
              <div className="w-full h-full rounded-full border-4 border-transparent border-t-cyan-500 border-r-blue-500"></div>
            </div>
          </div>
          
          <p className="text-gray-600 dark:text-gray-400 font-medium text-lg tracking-wide">Loading Dashboard...</p>
        </div>
